			...
			<div class="col-sm-10 content-block">
				<div class="main-contents">
					<div class="customer-search">
						...
						<form:form name="search" method="GET" action="${pageContext.request.contextPath}/application/search-sa/search" modelAttribute="applicationSearchSaForm">
								...
								<c:if test="${outputDto.searchCount > 0}">
									...
									<div class="customer-search-result">
										...
										<tr>
											...
											<td>
												<a href="${pageContext.request.contextPath}/application/detail-sa/index?id=${customerApplication.id}" class="btn btn-primary">参照</a>
											</td>
										</tr>
										</c:forEach>
										</table>
