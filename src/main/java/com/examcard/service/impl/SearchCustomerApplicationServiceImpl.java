...
import com.examcard.service.SearchCustomerApplicationService;
...
@Service
public class SearchCustomerApplicationServiceImpl implements SearchCustomerApplicationService {
	...
	public SearchResultDto search(SearchDto searchDto) {
		...
		List<ShinseiDto> customerApplicationDtoList = new ArrayList<>();
